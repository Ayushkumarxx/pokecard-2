      ...
      <>
        {stats.map((stat) => (
          <div key={stat.name} className="grid grid-cols-11 gap-1 mb-2 items-center">
            ...
            <div className="col-span-1 text-center text-xs font-bold text-white">{stat.name}</div>
            <div className="col-span-5 flex items-center justify-end">
              <StatBar 
                value={stat.right} 
                maxValue={255} 
        ...
        <div className="mt-3 pt-3 border-t border-gray-700">
          <div className="grid grid-cols-11 gap-1 items-center">
            ...
            <div className="col-span-1 text-center text-xs font-bold text-white">TOTAL</div>
            <div className="col-span-5 flex items-center justify-end">
              <StatBar 
                value={rightTotal} 
                maxValue={720} 
