...
// Renders the evolution chain of a Pokémon
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row justify-center items-center md:items-start gap-6 md:gap-8">
            {evolutionChain.map((evo, index) => (
              ...
              >
                <Link to={`/pokemon/${evo.id}`} className="block relative z-10 w-full group">
                  <div
