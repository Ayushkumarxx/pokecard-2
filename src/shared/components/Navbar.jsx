...
import { FaHeart, FaCodeCompare } from "react-icons/fa6"; // Import icons
  ...
  return (
    <nav className="max-w-[1440px] mx-auto px-4 py-4 flex flex-col md:flex-row gap-8 md:gap-0 justify-between items-center">
      ...
      <div className="flex flex-col gap-2 items-center">
        ...
        <h1 className="text-[18px] font-bold text-[#FFCB05] text-border-md leading-none">
          CARDS
        </h1>
      </div>
      ...
      <div className="flex gap-4 max-md:gap-2 items-center">
        ...
        >
          <FaHeart className="text-gray-300 text-[20px]" />
          <p className="text-gray-300 text-[14px] font-bold">
            {window.innerWidth > 768 ? "Favorites" : "Favs"}
          </p>
        </button>
        ...
        >
          <FaCodeCompare className="text-gray-300 text-[20px]" />
        </button>
      </div>
    </nav>
  );
